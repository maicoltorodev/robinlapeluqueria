        ...
        <div className="max-w-[1600px] mx-auto">
          ...
          <ScrollAnimation delay={300}>
            <div className="space-y-10 lg:space-y-12">
              ...
              {/* Premium Stats Card */}
              <PremiumCard>
                <div className="grid grid-cols-1 sm:grid-cols-3 gap-8 sm:gap-6 lg:gap-8 py-4 sm:py-0">
                  <div className="text-center">
                    <div className="text-5xl sm:text-5xl lg:text-6xl xl:text-7xl font-bold mb-2 sm:mb-3 text-background">10+</div>
                    <div className="text-[10px] sm:text-xs tracking-[0.2em] uppercase text-background/70 font-bold">Años de Experiencia</div>
                  </div>
                  <div className="text-center">
                    <div className="text-5xl sm:text-5xl lg:text-6xl xl:text-7xl font-bold mb-2 sm:mb-3 text-background">5K+</div>
                    <div className="text-[10px] sm:text-xs tracking-[0.2em] uppercase text-background/70 font-bold">Clientes Felices</div>
                  </div>
                  <div className="text-center">
                    <div className="text-5xl sm:text-5xl lg:text-6xl xl:text-7xl font-bold mb-2 sm:mb-3 text-background">15+</div>
                    <div className="text-[10px] sm:text-xs tracking-[0.2em] uppercase text-background/70 font-bold">Expertos</div>
                  </div>
                </div>
              </PremiumCard>
